...
public class CaseController {
    ...
    @PostMapping(value = "/saveCase", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public Case saveCase(@RequestBody Case _case) {
        return new Case();
    }
}
